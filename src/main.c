...
/*   Updated: 2025/06/16 16:28:29 by afelger          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int32_t main(void)
{
	...
	t_obj sphere = ft_sphere_create((t_sphere_p){1,(t_vec3){0,0,-4}}, FTVEC3(254.0));
	t_obj sphere1 = ft_sphere_create((t_sphere_p){1,(t_vec3){2,2,-10}}, FTVEC3(254.0));
	t_obj sphere2 = ft_sphere_create((t_sphere_p){.5,(t_vec3){-1,-1,-2}}, FTVEC3(254.0));
